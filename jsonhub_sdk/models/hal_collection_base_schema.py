...
T = TypeVar("T", bound="HalCollectionBaseSchema")


@_attrs_define
class HalCollectionBaseSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hal_collection_base_schema = cls(
        ...
        hal_collection_base_schema.additional_properties = d
        return hal_collection_base_schema
