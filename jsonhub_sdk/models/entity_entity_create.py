...
class EntityEntityCreate(BaseModel):
    """
    ...
    parent: Optional[EntityEntityCreate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": EntityEntityCreate.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "private": obj.get("private")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
EntityEntityCreate.model_rebuild(raise_errors=False)
