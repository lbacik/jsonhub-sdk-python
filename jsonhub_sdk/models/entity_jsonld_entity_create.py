...
class EntityJsonldEntityCreate(BaseModel):
    """
    ...
    parent: Optional[EntityJsonldEntityCreate] = None
    private: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["slug", "data", "definition", "parent", "private"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": EntityJsonldEntityCreate.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "private": obj.get("private")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
EntityJsonldEntityCreate.model_rebuild(raise_errors=False)
