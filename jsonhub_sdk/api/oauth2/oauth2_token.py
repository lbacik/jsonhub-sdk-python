...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = Oauth2TokenResponse200.from_dict(response.json())

        return response_200

    if response.status_code == 400:
        response_400 = Oauth2TokenResponse400.from_dict(response.json())

        return response_400

    if response.status_code == 401:
        response_401 = Oauth2TokenResponse401.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Union[Oauth2TokenResponse200, Oauth2TokenResponse400, Oauth2TokenResponse401]
    """
