...
T = TypeVar("T", bound="ApiDefinitionsGetCollectionResponse200")


@_attrs_define
class ApiDefinitionsGetCollectionResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_definitions_get_collection_response_200 = cls(
        ...
        api_definitions_get_collection_response_200.additional_properties = d
        return api_definitions_get_collection_response_200
