...
T = TypeVar("T", bound="ApiEntitiesGetCollectionResponse200")


@_attrs_define
class ApiEntitiesGetCollectionResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_entities_get_collection_response_200 = cls(
        ...
        api_entities_get_collection_response_200.additional_properties = d
        return api_entities_get_collection_response_200
