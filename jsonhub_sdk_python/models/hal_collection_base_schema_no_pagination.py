...
T = TypeVar("T", bound="HalCollectionBaseSchemaNoPagination")


@_attrs_define
class HalCollectionBaseSchemaNoPagination:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hal_collection_base_schema_no_pagination = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            total_items=total_items,
        )

        hal_collection_base_schema_no_pagination.additional_properties = d
        return hal_collection_base_schema_no_pagination
