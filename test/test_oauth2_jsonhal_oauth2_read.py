...
class TestOauth2JsonhalOauth2Read(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Oauth2JsonhalOauth2Read:
        """Test Oauth2JsonhalOauth2Read
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Oauth2JsonhalOauth2Read`
        """
    ...
    def testOauth2JsonhalOauth2Read(self):
        """Test Oauth2JsonhalOauth2Read"""
