...
class TestDefinitionJsonhalDefinitionReadLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DefinitionJsonhalDefinitionReadLinks:
        """Test DefinitionJsonhalDefinitionReadLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefinitionJsonhalDefinitionReadLinks`
        """
    ...
    def testDefinitionJsonhalDefinitionReadLinks(self):
        """Test DefinitionJsonhalDefinitionReadLinks"""
